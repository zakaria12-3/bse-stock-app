...
class SyncFinanceTransactions extends Command
{
     ...
     * @var string
     */
    protected $description = 'Synchroniser les ventes et achats existants avec le journal financier';
    ...
    {
        $this->info('Demarrage de la synchronisation du journal financier...');
        ...
        $bar->finish();
        $this->newLine();
        $this->info('Synchronisation du journal financier terminee avec succes.');
    }
}
