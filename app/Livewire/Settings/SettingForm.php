...
class SettingForm extends Component
{
    ...
    public function save()
    {
        ...
        try {
            ...
            $this->dispatch('toast', message: 'Parametre mis a jour avec succes.', type: 'success');
        } catch (\Exception $e) {
            $this->dispatch('toast', message: 'Echec de la mise a jour du parametre : ' . $e->getMessage(), type: 'error');
        }
    }
