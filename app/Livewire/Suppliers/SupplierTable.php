...
final class SupplierTable extends PowerGridComponent
{
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('Contact', 'contact_person')
                ->sortable()
                ->searchable(),
    ...
    public function actions(Supplier $row): array
    {
        return [
            ...
            Button::add('edit')
                ...
                ->tooltip('Modifier le fournisseur'),
            ...
            Button::add('delete')
                ...
                ->dispatch('open-delete-modal', [
                    ...
                    'description' => "Voulez-vous vraiment supprimer le fournisseur '{$row->name}' ? Cette action est definitive.",
                ])
                ->tooltip('Supprimer le fournisseur'),
        ];
    }
    ...
    public function delete($rowId, SupplierService $supplierService): void
    {
        ...
        if ($supplier) {
            try {
                ...
                $this->dispatch('toast', message: 'Fournisseur supprime avec succes.', type: 'success');
            } catch (\Exception $e) {
                $message = $e instanceof SupplierException
                    ? $e->getMessage()
                    : 'Echec de la suppression du fournisseur : ' . $e->getMessage();
