        ...
        return [
            ...
            Button::add('delete')
                ...
                ->dispatch('open-delete-modal', [
                    ...
                    'description' => "Voulez-vous vraiment supprimer l unite '{$row->name}' ? Cette action est definitive.",
                ])
                ->tooltip('Supprimer l unite'),
        ];
    }
    ...
    public function delete($rowId, UnitService $service): void
    {
        ...
        if ($unit) {
            try {
                ...
                $this->dispatch('toast', message: 'Unite supprimee avec succes.', type: 'success');
            } catch (\Exception $e) {
                $message = $e instanceof UnitException
                    ? $e->getMessage()
                    : 'Echec de la suppression de l unite : ' . $e->getMessage();
