...
final class UserTable extends PowerGridComponent
{
    ...
    public function fields(): PowerGridFields
    {
        return PowerGrid::fields()
            ...
            ->add('username')
            ->add('email')
            ->add('role', fn (User $model) => $model->role === 'admin' ? 'Admin' : 'Utilisateur')
            ->add('last_login_at_formatted', fn (User $model) => $model->last_login_at ? Carbon::parse($model->last_login_at)->diffForHumans() : 'Jamais')
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('Derniere activite', 'last_login_at_formatted', 'last_login_at')
                ->sortable(),
        ...
        return [
            ...
            Button::add('delete')
                ...
                ->dispatch('open-delete-modal', [
                    ...
                    'description' => "Voulez-vous vraiment supprimer l utilisateur '{$row->name}' ? Cette action est definitive.",
                ])
    ...
    public function delete($userId, \App\Services\UserService $service): void
    {
        ...
        if ($user) {
            try {
                ...
                $this->dispatch('toast', message: 'Utilisateur supprime avec succes.', type: 'success');
            } catch (\Exception $e) {
