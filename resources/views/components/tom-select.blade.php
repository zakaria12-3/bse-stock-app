@props(['options' => [], 'placeholder' => 'Choisir une option...', 'url' => null, 'method' => 'GET'])
            ...
            init() {
                ...
                this.$nextTick(() => {
                    ...
                    let config = {
                        ...
                        placeholder: (initialSearch && !this.value) ? initialSearch : '{{ __($placeholder) }}',
                        valueField: 'value',
                        labelField: 'text',
                        searchField: ['text'],
                        preload: 'focus',
                        ...
                        config.load = (query, callback) => {
                            ...
                            if (dataParams) {
                                try {
                                    ...
                                    console.error('Parametres de recherche invalides', e);
                                }
                            }
                            ...
                            fetch(url, {
                                ...
                                .then(response => {
                                    if (!response.ok) throw new Error('La reponse reseau est invalide');
                                ...
                                .then(json => {
                                    if (Array.isArray(json)) {
                                        ...
                                        console.warn('Chargement TomSelect : tableau attendu, recu', json);
                                        callback();
                                    }
                                })
                                .catch((error) => {
                                    console.error('Erreur de chargement TomSelect :', error);
                                    callback();
                                });
                        };
                    }
