        ...
        <div class="p-6">
            ...
            <div class="mb-6 space-y-1.5 text-center sm:text-left border-b border-gray-200 pb-4">
                <div class="flex items-center justify-between">
                    <h3 class="text-lg font-semibold leading-none tracking-tight text-foreground">
                        {{ __('Details du client') }}
                    </h3>
                </div>
                <p class="text-sm text-muted-foreground">
                    {{ __('Informations detaillees sur') }} {{ $customer->name }}.
                </p>
            </div>
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    <div class="space-y-1">
                        <label class="text-sm font-medium leading-none text-muted-foreground">{{ __('Telephone') }}</label>
                        <p class="text-sm text-foreground font-medium">{{ $customer->phone ?? '-' }}</p>
                    </div>
                </div>

                <div class="space-y-1">
                    <label class="text-sm font-medium leading-none text-muted-foreground">{{ __('Adresse') }}</label>
                ...
                <div class="space-y-1">
                    ...
                    <p class="text-sm text-foreground font-medium">
                        {{ $customer->notes ?: 'Aucune note renseignee.' }}
                    </p>
                </div>
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    <div class="space-y-1">
                        <label class="text-sm font-medium leading-none text-muted-foreground">{{ __('Date de creation') }}</label>
