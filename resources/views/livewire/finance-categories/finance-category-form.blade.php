    ...
    <div class="p-6">
        ...
        <div class="mb-6 space-y-1.5 text-center sm:text-left border-b border-gray-200 pb-4">
            <h3 class="text-lg font-semibold leading-none tracking-tight text-foreground">
                {{ $isEditing ? 'Modifier la categorie financiere' : 'Creer une categorie financiere' }}
            </h3>
            <p class="text-sm text-muted-foreground">
                {{ $isEditing ? 'Modifiez les informations de la categorie.' : 'Ajoutez une nouvelle categorie aux enregistrements financiers.' }}
            </p>
        </div>
        ...
        <form wire:submit="save" class="space-y-4">
            ...
            <x-form-input
                ...
                type="text"
                wire:model="name"
                placeholder="Ex. Electricite, salaires, vente d'actifs"
                required
            />
            ...
            <div class="mt-6 flex justify-end gap-3 border-t border-gray-200 pt-4">
                ...
                <x-primary-button type="submit" wire:loading.attr="disabled">
                    ...
                    {{ $isEditing ? 'Enregistrer les modifications' : 'Creer la categorie' }}
                </x-primary-button>
            </div>
        </form>
    </div>
