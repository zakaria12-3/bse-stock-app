    <form wire:submit="updateProfile" class="space-y-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 bg-gray-50 p-4 rounded-lg border border-gray-200">
            <div class="md:col-span-2">
                ...
                <p class="mt-1 text-sm text-muted-foreground">{{ __("Mettez a jour les informations du compte et l'adresse email.") }}</p>
            </div>
            ...
            <div class="space-y-2">
                <x-input-label for="username" :value="__('Identifiant')" required />
                <x-text-input
                    wire:model="username"
                    id="username"
                    name="username"
