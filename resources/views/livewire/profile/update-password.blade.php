    <form wire:submit="updatePassword" class="space-y-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 bg-gray-50 p-4 rounded-lg border border-gray-200">
            <div class="md:col-span-2">
                <h3 class="text-lg font-medium text-gray-900">{{ __('Modifier le mot de passe') }}</h3>
                <p class="mt-1 text-sm text-muted-foreground">{{ __('Utilisez un mot de passe long et difficile a deviner pour proteger le compte.') }}</p>
            </div>
